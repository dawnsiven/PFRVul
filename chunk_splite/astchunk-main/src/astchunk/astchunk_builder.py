...
class ASTChunkBuilder():
    ...
    def __init__(self, **configs):
        ...
        if self.language == "python":
            ...
            self.parser = ts.Parser(ts.Language(ts_cpp.language()))
        elif self.language == "javascript":
            self.parser = ts.Parser(ts.Language(ts_javascript.language()))           
        elif self.language == "php":
            self.parser = ts.Parser(ts.Language(ts_php.language()))               
        else:
